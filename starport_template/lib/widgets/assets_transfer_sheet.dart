...
class AssetsTransferSheet extends StatefulWidget {
  const AssetsTransferSheet({Key? key}) : super(key: key);
...
class _AssetsTransferSheetState extends State<AssetsTransferSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return CosmosBottomSheetContainer(child: Observer(builder: (context) {
      return SafeArea(
        top: false,
          ...
          contentChild: Padding(
            ...
            child: Column(
              children: [
                ...
                Text('1134.48 AKT', style: CosmosTextTheme.title0Medium),
                const Spacer(),
                Row(children: [Expanded(child: CosmosElevatedButton(onTap: () {}, text: 'Done'))])
              ],
            ),
          ),
        ),
