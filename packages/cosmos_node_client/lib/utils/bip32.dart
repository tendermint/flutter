...
import 'package:cosmos_node_client/utils/extensions.dart';
...
class Bip32EccCurve {
  ...
  final _EC_P = Uint8List.fromList(hex.decode('fffffffffffffffffffffffffffffffffffffffffffffffffffffffefffffc2f'));
