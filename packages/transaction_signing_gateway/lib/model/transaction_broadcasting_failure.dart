...
class TransactionBroadcasterNotFoundFailure
    extends TransactionBroadcastingFailure {
  @override
  TransactionBroadcastingFailType get type =>
      TransactionBroadcastingFailType.noTransactionBroadcasterFound;
}
...
class StorageProblemBroadcastingFailure extends TransactionBroadcastingFailure {
  ...
  // TODO: implement type
  TransactionBroadcastingFailType get type =>
      TransactionBroadcastingFailType.accountCredentialsStorageFailure;
}
